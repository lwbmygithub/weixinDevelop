...
import net.sf.json.JSONObject;  
	...
	public class WeixinUtil {  
	    ...
	    public static void httpRequestGetMedia(String requestUrl, String outputStr) {  
	        JSONObject jsonObject = null;  
	        StringBuffer buffer = new StringBuffer();  
	        try {  
	            // 创建SSLContext对象，并使用我们指定的信任管理器初始化  
	            ...
	            ImageUtil.saveImage(inputStream, "d:\\download.jpg");
	    ...
	    public static String getToken(){
	    	...
	    	JSONObject resultObject = WeixinUtil.httpRequest(url, "GET", null);
